...
public class PartsWarehouseTest {
    
    static Parts_Warehouse model;
    JSONObject json;
    boolean result;
    
    public PartsWarehouseTest(){}
    ...
    public static void setUpClass() {   
        ...
        model = new Parts_Warehouse(instance,false, instance.getBranchCode());
    }
...
//            json = model.setMaster("sWHouseNm","TEST WAREHOUSE");
...
//        } else {
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("PARTS WAREHOUSE");
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("sWHouseID  :  " + model.getMaster("sWHouseID"));
//            System.out.println("sWHouseNm  :  " + model.getMaster("sWHouseNm"));
...
//        }
//        
//        json = model.setMaster("sWHouseNm","EDIT WAREHOUSE");
//        if ("error".equals((String) json.get("result"))){
//            System.err.println((String) json.get("message"));
//            System.exit(1);
//        }
