...
public class PartsSectionTest {
    static Parts_Section model;
    JSONObject json;
    boolean result;
    
    public PartsSectionTest(){}
    ...
    public static void setUpClass() {   
        ...
        model = new Parts_Section(instance,false, instance.getBranchCode());
    }
...
//            json = model.setMaster("sSectnNme","TEST SECTION");
...
//        } else {
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("PARTS SECTION");
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("sSectnIDx  :  " + model.getMaster("sSectnIDx"));
//            System.out.println("sSectnNme  :  " + model.getMaster("sSectnNme"));
...
//        }
//        
//        json = model.setMaster("sSectnNme","EDIT SECTION");
//        if ("error".equals((String) json.get("result"))){
//            System.err.println((String) json.get("message"));
//            System.exit(1);
//        }
