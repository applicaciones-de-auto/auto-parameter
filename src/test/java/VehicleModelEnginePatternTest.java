...
public class VehicleModelEnginePatternTest {
    static Vehicle_ModelEnginePattern model;
    JSONObject json;
    boolean result;
    
    public VehicleModelEnginePatternTest(){}
    ...
    public static void setUpClass() {   
        ...
        model = new Vehicle_ModelEnginePattern(instance,false, instance.getBranchCode());
    }
...
////        
////        System.out.println("sBranch code = " + instance.getBranchCode());
////        Vehicle_ModelEnginePattern model = new Vehicle_ModelEnginePattern(instance, false, instance.getBranchCode());
////        
////        System.out.println("--------------------------------------------------------------------");
////        System.out.println("------------------------------NEW RECORD--------------------------------------");
////        System.out.println("--------------------------------------------------------------------");
...
//        System.err.println((String) json.get("message"));
//        
//        json = model.setMaster("nEngnLenx",10);
//        if ("error".equals((String) json.get("result"))){
//            System.err.println((String) json.get("message"));
//            System.exit(1);
//        }
