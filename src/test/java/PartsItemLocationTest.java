...
public class PartsItemLocationTest {
    
    static Parts_ItemLocation model;
    JSONObject json;
    boolean result;
    
    public PartsItemLocationTest(){}
    ...
    public static void setUpClass() {   
        ...
        model = new Parts_ItemLocation(instance,false, instance.getBranchCode());
    }
...
//            json = model.setMaster("sLocatnDs","TEST LOCATION");
//            if ("error".equals((String) json.get("result"))){
//                System.err.println((String) json.get("message"));
//                System.exit(1);
//            }
//            
//            json = model.setMaster("sBinIDxxx","M001001");
//            if ("error".equals((String) json.get("result"))){
//                System.err.println((String) json.get("message"));
//                System.exit(1);
//            }
//            
//            json = model.setMaster("sSectnIDx","M001001");
//            if ("error".equals((String) json.get("result"))){
//                System.err.println((String) json.get("message"));
//                System.exit(1);
//            }
//            
//            json = model.setMaster("sWHouseID","M001001");
//            if ("error".equals((String) json.get("result"))){
//                System.err.println((String) json.get("message"));
//                System.exit(1);
//            }
...
//        } else {
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("PARTS ITEM LOCATION");
//            System.out.println("--------------------------------------------------------------------");
//            System.out.println("sLocatnID  :  " + model.getMaster("sLocatnID"));
//            System.out.println("sLocatnDs  :  " + model.getMaster("sLocatnDs"));
...
//        }
//        
//        json = model.setMaster("sLocatnDs","EDIT ITEM LOCATION");
//        if ("error".equals((String) json.get("result"))){
//            System.err.println((String) json.get("message"));
//            System.exit(1);
//        }
