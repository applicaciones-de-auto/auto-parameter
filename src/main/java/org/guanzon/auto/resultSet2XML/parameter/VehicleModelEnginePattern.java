 ...
 * @author Arsiela
 */
public class VehicleModelEnginePattern {
    ...
    public static void main (String [] args){
        ...
        try {
            if (MiscUtil.resultSet2XML(instance, loRS, System.getProperty("sys.default.path.metadata"), "vehicle_model_engine_pattern", "")){
