 ...
 * @author Arsiela
 */
public class PartsInventoryCategory {
    ...
    public static void main (String [] args){
        ...
        System.setProperty("sys.default.path.metadata", "D:/GGC_Maven_Systems/config/metadata/Model_Parts_Inventory_Category.xml");
