 ...
 * @author Arsiela
 */
public class Vehicle_Make implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Vehicle_Make_Master poController;
    
    public Vehicle_Make(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Vehicle_Make_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sMakeIDxx"));
        }
        return poJSON;
    }

    @Override
    public Vehicle_Make_Master getModel() {
        return poController;
    }
}
