 ...
 * @author Arsiela
 */
public class DefaultReleasedItems_Checklist implements GRecord {
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Default_Released_Items_Checklist poController;
    
    public DefaultReleasedItems_Checklist(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Default_Released_Items_Checklist(foAppDrver,fbWtParent,fsBranchCd);
    ...
    @Override
    public Default_Released_Items_Checklist getModel() {
        return poController;
    }
