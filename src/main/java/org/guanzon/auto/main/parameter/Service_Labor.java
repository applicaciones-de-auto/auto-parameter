...
import org.guanzon.auto.controller.parameter.Service_Labor_Master;
 ...
 * @author Arsiela
 */
public class Service_Labor implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Service_Labor_Master poController;
    
    public Service_Labor(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Service_Labor_Master(foAppDrver,fbWtParent,fsBranchCd);
