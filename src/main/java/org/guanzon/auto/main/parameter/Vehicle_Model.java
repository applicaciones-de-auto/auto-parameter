 ...
 * @author Arsiela
 */
public class Vehicle_Model implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Vehicle_Model_Master poController;
    Vehicle_Make_Master poMake;
    
    public Vehicle_Model(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Vehicle_Model_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sModelIDx"));
        }
        return poJSON;
    }

    @Override
    public Vehicle_Model_Master getModel() {
        return poController;
    }
