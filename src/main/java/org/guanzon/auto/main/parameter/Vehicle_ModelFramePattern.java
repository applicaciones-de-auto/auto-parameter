...
import org.guanzon.auto.controller.parameter.Vehicle_ModelFramePattern_Master;
 ...
 * @author Arsiela
 */
public class Vehicle_ModelFramePattern implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Vehicle_ModelFramePattern_Master poController;
    Vehicle_Make_Master poMake;
    
    public Vehicle_ModelFramePattern(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Vehicle_ModelFramePattern_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    @Override
    public Vehicle_ModelFramePattern_Master getModel() {
        return poController;
    }
