 ...
 * @author Arsiela
 */
public class Insurance implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Insurance_Master poController;
    
    public Insurance(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Insurance_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sInsurIDx"));
        }
        return poJSON;
    }

    @Override
    public Insurance_Master getModel() {
        return poController;
    }
}
