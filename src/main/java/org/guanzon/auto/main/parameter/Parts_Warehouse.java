 ...
 * @author Arsiela
 */
public class Parts_Warehouse implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Parts_Warehouse_Master poController;
    
    public Parts_Warehouse(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Parts_Warehouse_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sWHouseID"));
        }
        return poJSON;
    }

    @Override
    public Parts_Warehouse_Master getModel() {
        return poController;
    }
