 ...
 * @author Arsiela
 */
public class Parts_Section implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Parts_Section_Master poController;
    
    public Parts_Section(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Parts_Section_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sSectnIDx"));
        }
        return poJSON;
    }

    @Override
    public Parts_Section_Master getModel() {
        return poController;
    }
