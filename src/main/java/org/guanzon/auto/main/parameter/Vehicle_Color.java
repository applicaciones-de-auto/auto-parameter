 ...
 * @author Arsiela
 */
public class Vehicle_Color implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Vehicle_Color_Master poController;
    
    public Vehicle_Color(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Vehicle_Color_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    @Override
    public Vehicle_Color_Master getModel() {
        return poController;
    }
