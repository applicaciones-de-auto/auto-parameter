 ...
 * @author Arsiela
 */
public class Parts_Bin implements GRecord{
    GRider poGRider;
    boolean pbWthParent;
    String psBranchCd;
    boolean pbWtParent;
    ...
    Parts_Bin_Master poController;
    
    public Parts_Bin(GRider foAppDrver, boolean fbWtParent, String fsBranchCd){
        poController = new Parts_Bin_Master(foAppDrver,fbWtParent,fsBranchCd);
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByActive) {
        ...
        if(!"error".equals(poJSON.get("result"))){
            poJSON = openRecord((String) poJSON.get("sBinIDxxx"));
        }
        return poJSON;
    }

    @Override
    public Parts_Bin_Master getModel() {
        return poController;
    }
