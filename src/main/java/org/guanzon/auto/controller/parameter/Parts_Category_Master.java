...
import org.guanzon.auto.model.parameter.Model_Parts_Category;
 ...
 * @author Arsiela
 */
public class Parts_Category_Master implements GRecord {
    ...
    Model_Parts_Category poModel;
    JSONObject poJSON;

    public Parts_Category_Master(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Parts_Category(foGRider);
    ...
    @Override
    public Model_Parts_Category getModel() {
        return poModel;
    }
