...
public class Activity_Source_Master implements GRecord {
    ...
    public Activity_Source_Master(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
    ...
    public JSONObject searchRecord(String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(poModel.makeSelectSQL(), " sActTypDs LIKE "
        ...
        if (poJSON != null) {
            return poModel.openRecord((String) poJSON.get("sActTypID"));
        } else {
            poJSON.put("result", "error");
            poJSON.put("message", "No record loaded to update.");
            return poJSON;
