...
import org.guanzon.auto.model.parameter.Model_Parts_Item_Type;
 ...
 * @author Arsiela
 */
public class Parts_ItemType_Master implements GRecord {
    ...
    Model_Parts_Item_Type poModel;
    JSONObject poJSON;

    public Parts_ItemType_Master(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
        pbWthParent = fbWthParent;

        poModel = new Model_Parts_Item_Type(foGRider);
    ...
    @Override
    public Model_Parts_Item_Type getModel() {
        return poModel;
    }
